...
from src.sb3.stable_baselines3.common.logger import Logger
...
from src.sb3.stable_baselines3.common.vec_env import DummyVecEnv, VecEnv, sync_envs_normalization

if TYPE_CHECKING:
    from src.sb3.stable_baselines3.common import base_class
...
class TensorboardCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        #self.logger.record("ball_position_x", ball_position[0])
        #self.logger.record("ball_position_y", ball_position[1])
        #self.logger.record("ball_position_z", ball_position[2])
        #self.logger.record("black_conceded", infos["black_conceded"])
        #self.logger.record("white_conceded", infos["white_conceded"])
        #self.logger.record("original_Reward", infos["original_Reward"])
